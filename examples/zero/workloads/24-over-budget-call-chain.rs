...
fn stage13(value: i32) -> i32 {
    stage12(value).wrapping_mul(3).wrapping_add(7)
}
fn stage14(value: i32) -> i32 {
    stage13(value).wrapping_mul(3).wrapping_add(7)
}
fn stage15(value: i32) -> i32 {
    stage14(value).wrapping_mul(3).wrapping_add(7)
}
fn stage16(value: i32) -> i32 {
    stage15(value).wrapping_mul(3).wrapping_add(7)
}
