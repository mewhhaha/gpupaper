...
export type DucklangCompilationWork = {
  ...
  readonly controlFlowFirstPassResidualDistinctNodeCount: number;
  readonly controlFlowFirstPassSearchOccurrenceCount: number;
  readonly controlFlowFirstPassSearchVertexCount: number;
    ...
    profile: {
      ...
      work: {
        ...
        controlFlowFirstPassResidualLoopCount:
          controlFlowLowering.firstPassResidualLoopCount,
        ...
        controlFlowFirstPassResidualDistinctNodeCount:
          controlFlowLowering.firstPassResidualDistinctNodeCount,
        controlFlowFirstPassSearchOccurrenceCount:
          controlFlowLowering.firstPassSearchOccurrenceCount,
        controlFlowFirstPassSearchVertexCount:
          controlFlowLowering.firstPassSearchVertexCount,
        ...
        specializationCacheHitCount:
          ...
          (postComptimeSpecialization?.metrics.specializationCacheHitCount ??
            0),
        specializationPendingCycleCount:
        ...
        specializationDistinctFunctionAnalysisCount:
          ...
          (postComptimeSpecialization?.metrics.distinctFunctionAnalysisCount ??
            0),
        specializationFunctionAnalysisCacheHitCount:
          preComptimeSpecialization.metrics.functionAnalysisCacheHitCount +
          (postComptimeSpecialization?.metrics.functionAnalysisCacheHitCount ??
            0),
        specializationRewrittenBlockCount:
          preComptimeSpecialization.metrics.rewrittenBlockCount +
          (postComptimeSpecialization?.metrics.rewrittenBlockCount ?? 0),
        specializationAvoidedEnvironmentEntryCopyCount:
  ...
  const profile: DucklangCompilationProfile = {
    ...
    work: {
      ...
      gpuWasmResolvedOffsetBytes: gpuWasmResult?.status === "completed"
        ...
        : 0,
      gpuWasmResolvedOffsetBitWidth: gpuWasmResult?.status === "completed"
        ? gpuWasmResult.resolvedOffsetBitWidth
        : 0,
      gpuWasmRankedLowWords: gpuWasmResult?.status === "completed" &&
          gpuWasmResult.lowWordLayout === "ranked"
        ? 1
        : 0,
      gpuWasmLowWordBytes: gpuWasmResult?.status === "completed"
        ? gpuWasmResult.lowWordBytes
        : 0,
      ...
      gpuWasmAtomInputBytes: gpuWasmResult?.status === "completed"
        ...
        : 0,
      gpuWasmSigned64AtomCount: gpuWasmResult?.status === "completed"
        ? gpuWasmResult.signed64AtomCount
        : 0,
      gpuWasmSigned64HighWordBytes: gpuWasmResult?.status === "completed"
        ? gpuWasmResult.signed64HighWordBytes
        : 0,
