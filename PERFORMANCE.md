...
- gpupaper base commit `76f44462df2294577445c9c27427dbeea4bc70f6`
  plus the working changes described by `TASKS.md`.
...
disables WebGPU. GPU mode requires the adapter and rejects any CPU/GPU Wasm
byte mismatch. Parser initialization is measured separately from syntax and AST
lowering.
...
| Codex     |        3,573 |      124.94 |        4.63 |            525.77 |           321.25 |            546.36 |           401.32 |     26,837 |
