...
| --------- | -----------: | ----------: | ----------: | ----------------: | ---------------: | ----------------: | ---------------: | ---------: |
| Editor    |       25,256 |      223.75 |       41.66 |            319.44 |           131.88 |            553.76 |           191.43 |     8,160² |
| Codex     |        3,573 |      124.94 |        4.63 |            525.77 |           321.25 |            546.36 |           401.32 |    26,196² |
| grep      |        2,856 |      117.90 |        2.64 |            209.26 |            66.60 |            218.32 |            91.83 |     1,322² |
| tar       |        6,587 |      121.12 |        9.86 |            242.25 |           101.92 |            385.19 |           197.67 |     8,178² |
...
² Re-recorded after immutable scalar `const` bindings began substituting before
Core construction. That removes their zero-argument Wasm functions and their
call sites; wav and raytracer contain no surviving scalar `const` bindings, so
their output sizes did not move.
